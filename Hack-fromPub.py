...
n = 115792089237316195423570985008687907852837564279074904382605163141518161494335
...
for _ in range(n):
    ...
    start_point = ECPoint(point.x, point.y)
    n = Secp256k1.scalar_mult(point.x, start_point)
