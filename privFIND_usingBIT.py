...
# for example pub:
public_key_x = 0x09c58240e50e3ba3f833c82655e8725c037a2294e14cf5d73a5df8d56159de69
public_key_y = 0x4fd08050375c910eecb46adeb9ffde4614adbf875f0493ad8d0a117d23b219e0
public_key = ECPoint(public_key_x, public_key_y)

# Specify the range of bits where the private key is located
start_bit = 30  # example value
end_bit = 32    # example value
